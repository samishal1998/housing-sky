...
DB_CONTAINER_NAME="housing-cloud-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=housing-cloud -d -p 5432:5432 docker.io/postgres
